...
export const CoverPreview = React.forwardRef<HTMLDivElement, CoverPreviewProps>(
  (
    ...
    return (
      <Card
        ref={ref} // Assign ref to the Card
          ...
          <div className="relative w-full aspect-square rounded-md overflow-hidden shadow-lg">
            {imageUrl ? (
              <Image
                ...
                unoptimized // Puede ayudar a html2canvas a obtener la imagen fuente más fácilmente
              />
            ) : (
...
CoverPreview.displayName = 'CoverPreview'; // Add display name for forwardRef
